...
function SuperSaleRenderer({
  bookList = [],
  classNames = "SuperSale-render",
  handleOnGetItem,
}) {
  return (
    <div className={classNames}>
      <div className="SuperSale__title">Siêu sale mở bán ngày 23/04</div>
      <SliderSuperSale
        data={bookList}
        type="superSale"
        render={() =>
                    ...
                    >
                      <span
                        ...
                        style={{
                          position: "absolute",
                          width: `${
                            bookUniqueItem?.rating_average * (100 / 5)
                          }%`,
                          whiteSpace: "nowrap",
                          left: " 0px",
                          top: "0px",
                      ...
                      >
                        <img
                          src="/assets/img/icon/star-opacity.svg"
                          alt="star"
                        />
                        <img
                          src="/assets/img/icon/star-opacity.svg"
...
export default SuperSaleRenderer;
